package HomeWork.lesson_8.gui;



import HomeWork.lesson_8.chess.ChessBoard;
import HomeWork.lesson_8.chess.ChessFigure;
import HomeWork.lesson_8.gui.components.Cell;
import HomeWork.lesson_8.gui.components.FigureGUI;
...
public class GameGUI extends JFrame {
    ...
    public GameGUI(String title){
        ...
        setSize(boardSize+5, boardSize + 107);
    ...
    public void arrangeFigures(){
        for (int i = 0; i < 8; i++) {
            for (int j = 0; j < 8; j++) {
                ...
                if (fig != null){
                    FigureGUI figGui = new FigureGUI(fig.getColor() + "_" + fig.toString(), j, i, cellSize);
